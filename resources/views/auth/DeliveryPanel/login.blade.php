{{-- ---------------------------------------------------🙏अंतः अस्ति प्रारंभः🙏--------------------------- --}}
@extends('auth.DeliveryPanel.Layouts.main')
@push('title')
    <title>Sign In | Delivery Panel</title>
@endpush
                                ...
                                <div class="p-lg-5 p-4">
                                    ...
                                    <div class="mt-4">
                                        <form action="#" method="POST" id="loginformid">
                                            <div>
                                                <h2 class="text-center fw-bold fs-2" style="color: #000000">Log In to Keep
                                                    the World Moving!</h2>
                                                <p class="text-muted text-center fs-5 fw-bold">Demo Phone : 9565485258</p>
                                    ...
                                    <form autocomplete="off" action="{{ route('LoginDeliveryotp') }}" id="signinotp"
