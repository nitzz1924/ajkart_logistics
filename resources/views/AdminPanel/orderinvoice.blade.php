                                                ...
                                                <td>
                                                    ...
                                                    <table width="850" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="font-size: 21px; color: #22005a; letter-spacing: -1px;  line-height: 1; vertical-align: top; text-align: right;">
                                                                    Invoice
                                                                </td>
                                                            </tr>
                                                            <tr>
                                        ...
                                        <td>
                                            <table width="800" border="0" cellpadding="0" cellspacing="0" align="center"
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                    <tr>
                                                        <td style="font-size: 16px;  color: #22005a;  line-height: 18px;  vertical-align: top; padding:10px 0;"
                                                            class="article">
                                                            {{ $rowdata['productname'] }}
                                                        </td>
